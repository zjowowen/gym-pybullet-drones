...
class FlyThruGateAviaryNoNorm(BaseSingleAgentAviary):
    ...
    def _clipAndNormalizeState(self,
        ...
        normalized_pos_xy = clipped_pos_xy / MAX_XY * MAX_XY #15
        normalized_pos_z = clipped_pos_z / MAX_Z * MAX_Z #5
        normalized_rp = clipped_rp / MAX_PITCH_ROLL * MAX_PITCH_ROLL#np.pi
        normalized_y = state[9] / np.pi * np.pi # No reason to clip
        normalized_vel_xy = clipped_vel_xy / MAX_LIN_VEL_XY * MAX_LIN_VEL_XY #3
        normalized_vel_z = clipped_vel_z / MAX_LIN_VEL_XY * MAX_LIN_VEL_XY #3
